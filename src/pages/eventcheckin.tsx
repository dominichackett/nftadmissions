    ...
    <section className="pt-8 pb-24">
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className=" w-1/2 px-1 lg:w-1/2 ">
            <div
              className="mb-12  flex  w-full items-center justify-center rounded-xl border border-stroke bg-white py-8 sm:py-14 md:py-24 lg:mb-0 lg:py-16 xl:py-28"
            >
              <img src="images/qrcode.png"  alt="details image" />
            </div>
          </div>
